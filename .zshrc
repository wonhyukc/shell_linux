...
alias cdt='cd ~/temp/'
alias cdgt='cd ~/git'
alias cdpg='cd ~/git/pgsql_hyuk101/Scripts'
alias cdpy='cd ~/git/pythonPrivate'
alias cddl='cd ~/git/Dlight.pgsql'
alias cdmr='cd /home/hyuk/gitUxn/AgmsT10Maria/Scripts'
export DOCKER_HOST=tcp://192.168.45.158:2375
